...
class CreateClientLimitsTable extends Migration
{
    public function up()
    {
        Schema::create('client_limits', function (Blueprint $table) {
            ...
            $table->foreignId('client_package_id')->constrained('client_package')->onDelete('cascade');
            ...
            $table->unsignedInteger('edit_limit')->default(0);
            $table->unsignedInteger('decline_limit')->default(0);
            $table->timestamps();
        });
    }
